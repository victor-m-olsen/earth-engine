...
var cop_lc = ee.Image("users/victormackenhauer/Cop_LC"),
    ...
    new_A = /* color: #999900 */ee.Geometry.Polygon(
    ...
    new_B = /* color: #009999 */ee.Geometry.Polygon(
    ...
    new_C = /* color: #ff00ff */ee.Geometry.Polygon(
    ...
    new_D = /* color: #ff9999 */ee.Geometry.Polygon(
