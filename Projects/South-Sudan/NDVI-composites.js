...
var cop_lc = ee.Image("users/victormackenhauer/Cop_LC"),
    ...
    ee.Geometry.Polygon(
        [[[28.05756201060241, 6.162606272314306],
          [28.05756201060241, 5.922250061876704],
          [28.37616552622741, 5.922250061876704],
          [28.37616552622741, 6.162606272314306]]], null, false),
    imageVisParam = {"opacity":1,"bands":["NDVI"],"min":0,"max":0.5,"palette":["ffffff","edba47","05a545"]},
    imageVisParam2 = {"opacity":1,"bands":["remapped"],"min":1,"max":5,"palette":["eb81ff","fde059","00a339","728f8f","ff3f08"]},
    sample_area = 
    /* color: #98ff00 */
    /* shown: false */
    ee.Geometry.MultiPolygon(
        [[[[27.24993484929407, 6.899325616750422],
           [26.25017898991907, 6.844788617365481],
           [26.279287132337164, 6.109488354775811],
           [26.504506858899664, 5.806264877057526],
           [26.932973655774664, 5.636825203425995],
           [27.191152366712164, 5.5958242460373],
           [27.301015647962164, 5.814462290736887],
           [27.237844261243414, 5.967458578315166],
           [27.092275413587164, 6.090371137248994],
           [27.377919944837164, 6.123143092281795],
           [27.449331077649664, 6.185950376630574],
           [27.476796897962164, 6.317002326785752],
           [27.654417012181458, 6.613192279768571],
           [27.695615742650208, 6.798682014436425]]],
         [[[28.073933333164533, 6.830683882217371],
           [27.980549544102033, 6.48694957165276],
           [27.799275130039533, 5.765998003830825],
           [27.716877669102033, 5.443451151063765],
           [27.799275130039533, 5.284847082174841],
           [28.035481184727033, 5.213735448056281],
           [28.194782942539533, 5.10978860134712],
           [28.507893294102033, 4.945627795970343],
           [28.925373762852033, 4.907317701102494],
           [29.546101301914533, 5.159028704524129],
           [29.694416731602033, 5.202794479042575],
           [29.579060286289533, 5.55280897025596],
           [29.562580794102033, 5.924471438957303],
           [29.524128645664533, 6.279503536560718],
           [29.073689192539533, 6.568812813969318],
           [28.903401106602033, 6.6997659226741835]]]]);
...
Map.addLayer(new2016, imageVisParam2, 'new2016', false)
Map.addLayer(new2017, imageVisParam2, 'new2017', false)
Map.addLayer(new2018, imageVisParam2, 'new2018', false)
...
var sentinel2_mosaics = mosaic_maker(sentinel2_masked).select('NDVI');
...
Map.addLayer(ee.Image(listOfImages.get(10)), imageVisParam, 'img11', false)
Map.addLayer(ee.Image(listOfImages.get(11)), imageVisParam, 'img12', false)
