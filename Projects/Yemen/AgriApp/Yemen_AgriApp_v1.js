...
var imageVisParams = {"bands":["red","green","blue"],"gamma":1,"max":2875.28,"min":200.72,"opacity":1},
    ...
    yem_adm3 = ee.FeatureCollection("users/pedrovieirac/Yemen/yem_adm3_polygons"),
...
var WaPor_LULC17 = ee.Image("users/pedrovieirac/Yemen/WaPor_LULC_17");
var WaPor_LULC18 = ee.Image("users/pedrovieirac/Yemen/WaPor_LULC_18");
var WaPor_LULC19 = ee.Image("users/pedrovieirac/Yemen/WaPor_LULC_19");
var WaPor_LULC20 = ee.Image("users/pedrovieirac/Yemen/WaPor_LULC_20");
...
var chart_area = function(geo) {return ui.Chart.image.series(filtered_collect, geo, ee.Reducer.count(), 100)
      .setOptions({
...
//Application Tittle
var title = ui.Label({
  value: 'NDVI of Agricultural Areas in Yemen 2019-2021',
  style: {
    position: 'top-center',
    backgroundColor: 'ffffff22',
      // fontWeight: 'light',
