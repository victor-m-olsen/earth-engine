...
var sand = /* color: #ffc82d */ee.FeatureCollection(
    ...
    ee.Geometry.Polygon(
        [[[29.55358554009341, 5.039262698691543],
          [29.55358554009341, 3.7796002431037787],
          [31.68493319634341, 3.7796002431037787],
          [31.68493319634341, 5.039262698691543]]], null, false),
...
////Visualizing some of the images in the Sentinel-2 imageCollection
...
// Visualizing the first composite
...
// Map.addLayer(sentinel2_mosaics.filterMetadata('month', 'equals', 4), imageVisParam, 'Comp 4', false)
...
// Map.addLayer(sentinel2_mosaics.filterMetadata('month', 'equals', 10), imageVisParam, 'Comp 10', false)
